...
const routes = [
    ...
    { path: '/backoffice/certifications', permissions: ['ADMIN',] },
    { path: '/backoffice/users', permissions: ['ADMIN',] },
    { path: '/backoffice/restaurants', permissions: ['ADMIN',] },
    { path: '/backoffice/menus', permissions: ['ADMIN',] },
    { path: '/backoffice/animals', permissions: ['ADMIN',] },
    { path: '/backoffice/animalProducts', permissions: ['ADMIN',] },
    { path: '/backoffice/eggsBatchs', permissions: ['ADMIN',] },
    { path: '/backoffice/eggsBatchProducts', permissions: ['ADMIN',] },
    { path: '/backoffice/eggsBatchLines', permissions: ['ADMIN',] },
    { path: '/backoffice/orders', permissions: ['ADMIN',] },
    { path: '/backoffice/orderLines', permissions: ['ADMIN',] },
    { path: '/backoffice/orderHistory', permissions: ['ADMIN',] },
