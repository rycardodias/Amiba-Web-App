  ...
  return <Box pt={2} pb={4}>
    <Grid container spacing={3}>
      <Grid item md={7} sm={7} xs={12}>
        ...
        {!isLoading && data.map((item, index) => <CartListItem key={index} item={item} btnClick={handleBtnClick} removeItemList={handleRemoveItem} refreshQuantity={handleRefreshQuantity} />)}
      </Grid>
