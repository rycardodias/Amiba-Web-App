...
// newColumn('VAT', 'fiscalNumber', 100, SelectColumnFilter)

const newColumn = (Header, accessor, minWidth, Filter, Cell) => {
  const obj = {
    minWidth: minWidth,
    Header: Header,
    accessor: accessor,
...
for (const element of columnValues) {
  const result = newColumn(element.Header, element.accessor,
    element.minWidth, element.Filter, element.Cell)
  console.log(result)
}
