...
import columnShape from "components/backoffice/eggsBatches/ColumnShape";
import AddModal from "components/backoffice/eggsBatches/AddModal";
...
export const List = () => {
    ...
    const tableName = t('Eggs Batches')
    const tableSingleName = t('Eggs Batch')
    useTitle(tableName);
    ...
    function getInitialData() {
        eggsBatchsRequests.getEggsBatchsUserId()
            .then(response => {
