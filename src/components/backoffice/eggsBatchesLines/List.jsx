...
import columnShape from "components/backoffice/eggsBatchesLines/ColumnShape";
import AddModal from "components/backoffice/eggsBatchesLines/AddModal";
...
export const List = () => {
    ...
    const tableName = t('Eggs Batches Lines')
    const tableSingleName = t('Eggs Batch Line')
    useTitle(tableName);
    ...
    function getInitialData() {
        eggsBatchsLinesRequests.getEggsBatchsLinesUserId()
            .then(response => {
    ...
    const handleDelete = async () => {
        ...
        for (let id of ids) {
            const res = await eggsBatchsLinesRequests.deleteEggsBatchsLines(id)
