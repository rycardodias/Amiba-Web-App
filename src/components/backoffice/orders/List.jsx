...
import columnShape from "components/backoffice/orders/ColumnShape";
// import AddModal from "components/backoffice/orders/AddModal";
import * as ordersRequests from 'lib/requests/ordersRequests'

export const List = () => {
    const { t } = useTranslation();
    const tableName = t('Orders')
    const tableSingleName = t('Order')
    useTitle(tableName);
    ...
    //     for (let id of ids) {
    //         const res = await ordersRequests.deleteOrder(id)
