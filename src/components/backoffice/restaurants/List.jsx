...
import columnShape from "components/backoffice/restaurants/ColumnShape";
import AddModal from "components/backoffice/restaurants/AddModal";
import * as restaurantsRequests from 'lib/requests/restaurantsRequests'

export const List = () => {
    const { t } = useTranslation();
    const tableName = t('Restaurants')
    const tableSingleName = t('Restaurant')
    useTitle(tableName);
    ...
    function getInitialData() {
        restaurantsRequests.getRestaurants()
            .then(response => {
    ...
    const handleDelete = async () => {
        ...
        for (let id of ids) {
            const res = await restaurantsRequests.deleteRestaurant(id)
