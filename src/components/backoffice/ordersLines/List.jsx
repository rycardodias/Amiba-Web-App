...
import columnShape from "components/backoffice/ordersLines/ColumnShape";
// import AddModal from "components/backoffice/ordersLines/AddModal";
import * as orderLinesRequests from 'lib/requests/orderLinesRequests'
...
export const List = () => {
    ...
    function getInitialData() {
        orderLinesRequests.getOrdersLinesUserId()
            .then(response => {
    ...
    //     for (let id of ids) {
    //         const res = await orderLinesRequests.deleteOrderLine(id)
