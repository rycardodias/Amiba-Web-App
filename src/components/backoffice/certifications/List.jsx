...
export const List = () => {
    ...
    const tableName = t('Certifications')
    const tableSingleName = t('Certifications')
    useTitle(tableName);
    ...
    function getInitialData() {
        certificationsRequests.getCertifications()
            .then(response => {
    ...
    const handleDelete = async () => {
        ...
        for (let id of ids) {
            const res = await certificationsRequests.deleteCertification(id)
